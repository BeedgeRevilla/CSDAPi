Feature: REGIONAL Retrieve Customer
  ...
  @HK
    Examples:
      ...
      | HK     |     | HK_SCRM_LIFE_02 | HK_SCRM_LIFE_02 | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 6/232486/6       | DESC  |
      ...
      | HK     |     | HK_SCRM_LIFE_01 | HK_SCRM_LIFE_01 | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 005236           | DESC  |
      | HK     |     | HK_SCRM_LIFE_02 | HK_SCRM_LIFE_02 | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 232486/6         | DESC  |
      | HK     |     | HK_SCRM_PSEA_01 | HK_SCRM_PSEA_01 | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 79363(0)         | DESC  |
      | HK     |     | HK_SCRM_PSEA_02 | HK_SCRM_PSEA_02 | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 21843(4)         | DESC  |
  ...
  @PH
    Examples:
      ...
      | PH     |     | PH_SCRM_02  | PH_SCRM_02   | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | ZRS43694804N554() | DESC  |
      | PH     |     | PH_EFUSE_01 | PH_EFUSE_01  | NFT1 | COREDB       | EFUSE        | application/json | SECURITYNO         | TXT43765752N554() | DESC  |
      | PH     |     | PH_EFUSE_02 | PH_EFUSE_02  | NFT1 | COREDB       | EFUSE        | application/json | SECURITYNO         | YJI43134854N554() | DESC  |
  ...
  @SG
    Examples:
      ...
      | SG     |      | SG_SCRM_HEALTH_02 | SG_SCRM_HEALTH_02 | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 10163555         | DESC  |
  ...
  @TH
    Examples:
      ...
      | TH     | Life | TH_SCRM_02 | TH_SCRM_01   | NFT1 | COREDB       | SCRM         | application/json | SECURITYNO         | 9524488396293    | DESC  |
