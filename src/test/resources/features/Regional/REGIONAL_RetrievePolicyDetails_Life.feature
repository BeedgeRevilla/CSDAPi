Feature: REGIONAL Retrieve Policy Details Life
  ...
  @SG
    Examples:
      ...
      #with Policy Riders
      | SG     | Life | SG_LIFE_SCRM_01  | SG_LIFE_SCRM_01  |     | RLS          | SCRM         | application/json | 302-5951322  |
      | SG     | Life | SG_LIFE_SCRM_02  | SG_LIFE_SCRM_02  |     | RLS          | SCRM         | application/json | 302-5778915  |
      | SG     | Life | SG_LIFE_MYAXA_01 | SG_LIFE_MYAXA_01 |     | RLS          | MYAXA        | application/json | 302-5945878  |
      | SG     | Life | SG_LIFE_MYAXA_02 | SG_LIFE_MYAXA_02 |     | RLS          | MYAXA        | application/json | 302-5948252  |
      | SG     | Life | SG_LIFE_IAAS_01  | SG_LIFE_IAAS_01  |     | RLS          | IAAS         | application/json | 302-5949789  |
      | SG     | Life | SG_LIFE_IAAS_02  | SG_LIFE_IAAS_02  |     | RLS          | IAAS         | application/json | 302-5945753  |
